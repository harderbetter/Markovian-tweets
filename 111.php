...
<button id="But1" onclick="myFunction2()">Tweet User Generate</button>

<p>tweet text:</p><input type="text" name="Text2" id="myText2" name="ppp" value="">

<button style="background-color:lightgreen" id="But2" onclick="myFunction2()">Your own sentence generate</button>
...
$myfile = fopen("tweet.txt", "w") or die("Unable to open file!");
      ...
      $dom2 = $_POST['Text2'];
      $dom1 = $_POST['Text1'];
$tmp = exec("python 2.py $dom1");
$po = 'tweet.txt';
$pop = file_get_contents($po);
