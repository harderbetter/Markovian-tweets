...
<button id="But1" onclick="myFunction1()">Create</button>
...
<script>
    ...
    var original_content = "<?php echo $original_content?>";
    
    function myFunction1() {
        var x = document.getElementById("myText1").value;
        document.getElementById("myText4").value = x;
        document.getElementById("myText5").Value = original_content;
